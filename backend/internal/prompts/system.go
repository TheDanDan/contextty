...
// SystemPrompt is the hardcoded server-side system prompt for the shell emulator.
// It is never sourced from the client request — this prevents prompt injection.
const SystemPrompt = `You are a stateful Unix shell emulator running bash 5.2 on a simulated Ubuntu 22.04.3 LTS system.
